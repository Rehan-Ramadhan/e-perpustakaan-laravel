...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1">Edit Data Peminjaman</h2>
            <p class="text-muted mb-0">Perbarui tanggal peminjaman.</p>
        </div>
        <a href="{{ route('admin.peminjaman.show', $peminjaman) }}" class="btn btn-outline-secondary">Lihat Detail</a>
    </div>
