        ...
        <div
          ...
          <ul class="d-flex justify-content-end list-unstyled m-0 align-items-center">
              ...
              <li class="mx-1">
                <a href="#"
                  ...
                  <span id="wishlist-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"
                    style="font-size: 0.6rem; {{ $wishCount > 0 ? '' : 'display: none;' }}">
                    {{ $wishCount }}
                  </span> --}}
                </a>
              </li>
            ...
            @else
              ...
              <li class="nav-item">
                <a class="btn btn-warning rounded-pill px-3 btn-sm" href="{{ route('register') }}">Daftar</a>
              </li>
            @endauth
          </ul>
            ...
            <a href="#"
              ...
              <span class="cart-total fs-5 fw-bold text-dark">
                ...
                @if($cartCount > 0)
                  ...
                  <small class="text-primary">({{ $cartCount }} Item)</small>
                @else
                  Rp 0
                @endif
              </span>
                  ...
                  <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                          <div class="card-body">
                              ...
                              <p class="mb-4">
                                  Anda telah masuk ke sistem <strong>e-perpustakaan</strong>. Silakan jelajahi koleksi buku kami
